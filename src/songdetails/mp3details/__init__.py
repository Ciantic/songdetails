...
def _genre_convert(genre):
    ...
    Tries to lookup from known numeric genre table for the actual genre reason
    unknown some players seems to save Genres such as: C{"(17)"} meaning Rock,
    number from ID3v1 and parentheses for fun apparently.
...
class MP3Details(SongFileDetails):
    ...
    def __init__(self, filepath):
        """Create and parse MP3 details from file.
...
songdetails.register_file_scan(scan, ('.mp3', ))